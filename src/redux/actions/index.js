import { GOLOGIN, GOHOME, ELOGIN, LOGIN_RECEIVED, STATION_RECEIVED, ESTATION_LOAD, STATION_EXPAND} from './actionType';
...
export const onExpand               = (inx, isOpen) => { return { type:  STATION_EXPAND, index: inx, isOpen: isOpen }};
